...
- Estudos sobre React Hooks (useState, useEffect e useRef).

### Próximas features a serem adcionadas:

- Alerta sonoro na conclusão do timer.
- Tela da task específica, onde o usuário poderá adcionar detalhes.
